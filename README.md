...
**Install all the required libraries into your R environment. 
-Since we are working with dplyr, plotly, shiny, ggplot2, scales and tidyr, you need to install them.
**Get to the folder structure next. Make sure that you have a folder with all dedicated files in it. 
